 ...
 * @LastEditTime: 2020-03-23 20:14:59
...
public:
    ...
    long long int nextHugeInt( long long int low, long long int high )
    {
        uniform_int_distribution<long long int> distribution( low, high );
        return distribution( generator );
    }
